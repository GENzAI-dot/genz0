      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="text-center space-y-6 animate-fade-in">
            <div className="inline-flex items-center space-x-2 bg-muted/50 px-4 py-2 rounded-full animate-float hover:bg-muted/70 transition-colors highlight-pulse">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="card-mystical text-center animate-scale-in [animation-delay:0.6s] opacity-0 [animation-fill-mode:forwards] hover:scale-105 transition-transform duration-300 group h-full highlight-pulse">
              <CardHeader>
            ...
            <Card className="card-mystical text-center animate-scale-in [animation-delay:0.8s] opacity-0 [animation-fill-mode:forwards] hover:scale-105 transition-transform duration-300 group h-full">
              <CardHeader>
            ...
            <Card className="card-mystical text-center animate-scale-in [animation-delay:1s] opacity-0 [animation-fill-mode:forwards] hover:scale-105 transition-transform duration-300 group h-full">
              <CardHeader>
          ...
          <div className="text-center space-y-8 animate-fade-in-up [animation-delay:1.2s] opacity-0 [animation-fill-mode:forwards]">
            ...
            <Button 
              ...
              size="lg" 
              className="btn-cosmic text-lg px-8 py-6 h-auto hover:animate-cosmic-pulse transition-all duration-300 group highlight-pulse hover:scale-105 active:scale-95"
            >
          ...
          <div className="text-center space-y-6 animate-fade-in-up [animation-delay:1.6s] opacity-0 [animation-fill-mode:forwards]">
            ...
            <Button 
              ...
              variant="outline" 
              size="lg" 
              className="text-lg px-8 py-6 h-auto border-2 border-primary/20 hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 group hover:scale-105 active:scale-95"
            >
